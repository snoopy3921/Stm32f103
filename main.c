...
void i2c_Write(uint32_t address, uint32_t address_Word, uint32_t data)
  ...
  I2C_SendData(I2C1,address_Word);//EV8_1 Choose address data to DR
  ...
  while (!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_BYTE_TRANSMITTING));//EV8_2
...
void i2c_Read(uint32_t address, uint32_t address_Word)
  ...
  while (!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED));//EV6
	...
	I2C_SendData(I2C1, address_Word);//Dia chi o nho
